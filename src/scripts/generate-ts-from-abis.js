...
for(const buildArtifact of shell.ls('./src/contracts/*.json')) {
...
shell.ShellString(generationInterfaceOutput).to('./src/abi-interfaces.ts');

console.log(`Generated ./src/abi-interfaces.ts from ${contracts.size} contracts`);
